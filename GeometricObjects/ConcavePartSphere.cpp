...
ConcavePartSphere::ConcavePartSphere (void)	
	: 	GeometricObject(),
		...
		phi_max(TWO_PI<double>),		// in radians
		theta_min(0.0),			// in radians measured from top
		theta_max(PI<double>),			// in radians measured from top
		cos_theta_min(1.0),
		cos_theta_max(-1.0)
{}
...
ConcavePartSphere::ConcavePartSphere (const Point3D 	c, 
	...
	: 	GeometricObject(),
		center(c),
		radius(r),
		phi_min(azimuth_min * PI_ON_180<double>),			// in radians
		phi_max(azimuth_max * PI_ON_180<double>),			// in radians
		theta_min(polar_min * PI_ON_180<double>),			// in radians measured from top
		theta_max(polar_max * PI_ON_180<double>),			// in radians measured from top
...
bool 																						 
ConcavePartSphere::shadow_hit(const Ray& ray, double& tmin) const
{
	double 		t;
	Vector3D  	temp 	= ray.o - center;
	double 		a 		= ray.d * ray.d;
