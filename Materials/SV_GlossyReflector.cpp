...
RGBColor
SV_GlossyReflector::shade(ShadeRec& sr) const {
...
RGBColor
SV_GlossyReflector::get_Le(ShadeRec const & sr) const
{
	return RGBColor(1.0);
}
	
RGBColor
SV_GlossyReflector::area_light_shade(ShadeRec & sr) const			//this is for chapter 18 page one image ad-hoc
{
