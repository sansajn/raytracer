...
void World::build() {
	...
	image_ptr1->read_ppm_file("assets/sandstone_ramp1.ppm");
	...
	Instance* cylinder_ptr1 = new Instance(make_shared<SolidCylinder>(bottom, top, radius));
	...
	image_ptr2->read_ppm_file("assets/sandstone_ramp2.ppm");
	...
	Instance* cylinder_ptr2 = new Instance(make_shared<SolidCylinder>(bottom, top, radius));
	...
	image_ptr3->read_ppm_file("assets/sandstone_ramp3.ppm");
	...
	Instance* cylinder_ptr3 = new Instance(make_shared<SolidCylinder>(bottom, top, radius));
	...
	image_ptr4->read_ppm_file("assets/sandstone_ramp4.ppm");
	...
	Instance* cylinder_ptr4 = new Instance(make_shared<SolidCylinder>(bottom, top, radius));
