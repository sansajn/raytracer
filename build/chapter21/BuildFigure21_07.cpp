...
#include "GeometricObjects/BeveledRing.h"
...
void World::build() {
	...
	Instance* cylinder_ptr = new Instance(make_shared<BeveledCylinder>(y0, y1, radius, bevel_radius));
	...
	Instance* ring_ptr = new Instance(make_shared<BeveledRing>(y0, y1, inner_radius, outer_radius, bevel_radius));
	...
	Instance* box_ptr = new Instance(make_shared<BeveledBox>(p0, p1, bevel_radius));
	box_ptr->rotate_y(-10);
