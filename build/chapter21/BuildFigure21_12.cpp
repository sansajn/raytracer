...
void World::build() {
	...
	phong_ptr->set_cd(RGBColor{0.7, 0.5, 0});		// orange
	...
	Instance* cylinder_ptr1 = new Instance(make_shared<BeveledCylinder>(y0, y1, radius, bevel_radius));
	...
	Instance* cylinder_ptr3 = new Instance(make_shared<BeveledCylinder>(y0, y1, radius, bevel_radius));
	...
	plane_ptr->set_material(make_shared<Matte>(.25, 1, RGBColor{1}));
