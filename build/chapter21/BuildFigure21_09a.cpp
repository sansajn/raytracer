...
#include "GeometricObjects/ConcavePartCylinder.h"
...
void World::build() {
	...
	matte_ptr1->set_cd(RGBColor{0.5, 1, 0.5});	  // green
	...
	matte_ptr2->set_cd(RGBColor{1.0, 0.5, 0.0});	// orange
	...
	matte_ptr3->set_cd(RGBColor{1, 1, 0.0});	// yellow
