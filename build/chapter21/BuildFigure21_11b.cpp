...
void World::build() {
	...
	background_color = RGBColor(0.4, 0.4, 0.8);
	...
	auto archway_ptr = make_shared<Archway>(width, height, depth, column_width, num_blocks, num_wedges, bevel_radius);
	...
	auto wall_ptr = make_shared<Grid>();
	...
	image_ptr2->read_ppm_file("assets/GrayMarbleRamp.ppm");
