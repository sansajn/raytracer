...
// This builds the scene for Figure 23.10(b)
// The scene is Naomi Hatchman's penguin with smooth shading
...
void World::build() {
	...
	body_ptr->read_smooth_triangles("assets/penguin/penguin_body.ply");
	...
	left_wing_ptr->read_smooth_triangles("assets/penguin/penguin_left_wing.ply");
	left_wing_ptr->set_material(matte_ptr2);  
	left_wing_ptr->setup_cells();
	
	Grid* right_wing_ptr = new Grid;
	right_wing_ptr->read_smooth_triangles("assets/penguin/penguin_right_wing.ply");
	...
	left_foot_ptr->read_smooth_triangles("assets/penguin/penguin_left_foot.ply");
	left_foot_ptr->set_material(matte_ptr3);  
	left_foot_ptr->setup_cells();
	
	Grid* right_foot_ptr = new Grid;
	right_foot_ptr->read_smooth_triangles("assets/penguin/penguin_right_foot.ply");
	...
	left_eyeball_ptr->read_smooth_triangles("assets/penguin/penguin_left_eyeball.ply");
	left_eyeball_ptr->set_material(matte_ptr4);  
	left_eyeball_ptr->setup_cells();
	
	Grid* right_eyeball_ptr = new Grid;
	right_eyeball_ptr->read_smooth_triangles("assets/penguin/penguin_right_eyeball.ply");
	...
	left_lower_eyelid_ptr->read_smooth_triangles("assets/penguin/penguin_left_lower_eyelid.ply");
	left_lower_eyelid_ptr->set_material(matte_ptr5);  
	left_lower_eyelid_ptr->setup_cells();
	
	Grid* right_lower_eyelid_ptr = new Grid;
	right_lower_eyelid_ptr->read_smooth_triangles("assets/penguin/penguin_right_lower_eyelid.ply");
	right_lower_eyelid_ptr->set_material(matte_ptr5);  
	right_lower_eyelid_ptr->setup_cells();
	
	
	Grid* left_upper_eyelid_ptr = new Grid;
	left_upper_eyelid_ptr->read_smooth_triangles("assets/penguin/penguin_left_upper_eyelid.ply");
	left_upper_eyelid_ptr->set_material(matte_ptr5);  
	left_upper_eyelid_ptr->setup_cells();
	
	Grid* right_upper_eyelid_ptr = new Grid;
	right_upper_eyelid_ptr->read_smooth_triangles("assets/penguin/penguin_right_upper_eyelid.ply");
