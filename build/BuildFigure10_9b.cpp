...
// This builds the scene for Figure 10.9
// MultiJittered sampling is specified with the ViewPlane::set_sampler function
// because a single MultiJittered sample is random.
...
void World::build() {
//	constexpr int num_samples = 25;  // for Figure 10.9(a)
	constexpr int num_samples = 1;  //  for Figure 10.9(b)
