...
void World::build() {
	...
	Instance* cylinder_ptr = new Instance(make_shared<SolidCylinder>(-2.5, 4.0, 1.95));
	...
	checker_ptr5->set_color1(RGBColor{0.35});
	checker_ptr5->set_color2(RGBColor{0.5});
