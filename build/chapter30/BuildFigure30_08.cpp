...
void World::build() {
	...
	radius = 3.0;
	Instance* sphere_ptr1 = new Instance(make_shared<Sphere>(Point3D(0.0), radius));
	...
	radius = 2.25;	
	Instance* sphere_ptr2 = new Instance(make_shared<Sphere>(Point3D(0.0), radius));
	...
	radius = 1.75;	
	Instance* sphere_ptr3 = new Instance(make_shared<Sphere>(Point3D(0.0), radius));
	...
	radius = 1.0;	
	Instance* sphere_ptr4 = new Instance(make_shared<Sphere>(Point3D(0.0), radius));
	...
	radius = 0.75;	
	Instance* sphere_ptr5 = new Instance(make_shared<Sphere>(Point3D(0.0), radius));
	...
	radius = 0.5;	
	Instance* sphere_ptr6 = new Instance(make_shared<Sphere>(Point3D(0.0), radius));
