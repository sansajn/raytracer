// Multithread pinole camera test scene based on code for Figure 24.6b
#include "World/World.h"
#include "Tracers/Whitted.h"
#include "Cameras/PinholeMT.h"
...
void World::build() {
	...
	auto pinhole_ptr = make_unique<PinholeMT>();
