/*! Scene from chapter 3 title page.
\note Colors in generated image doesn't match with reference image, but there is not any
color processing in World::hit_bare_bones_objects so the output must be right. */
