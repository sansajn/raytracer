...
void World::build() {
	...
	glossy_ptr1->set_cd(RGBColor{0, 0.5, 0.25});
	...
	Box* box_ptr1 = new Box{
		{-10.0 * checker_size, 0, -0.5},
		{-6.0 * checker_size, 5 * checker_size, 0.0}};
	box_ptr1->set_material(glossy_ptr1);
	add_object(box_ptr1);
	
	float exp2 = 10000.0;
	auto glossy_ptr2 = make_shared<GlossyReflector>();
	glossy_ptr2->set_cd(RGBColor{0, 0.5, 0.25});
	...
	Box* box_ptr2 = new Box{
		{-5.0 * checker_size, 0, -0.5},
		{-checker_size, 5 * checker_size, 0.0}};
	box_ptr2->set_material(glossy_ptr2);
	add_object(box_ptr2);
	
	float exp3 = 1000.0;
	auto glossy_ptr3 = make_shared<GlossyReflector>();
	glossy_ptr3->set_cd(RGBColor{0, 0.5, 0.25});
	...
	Box* box_ptr3 = new Box{
		{0, 0, -0.5},
		{4 * checker_size, 5 * checker_size, 0.0}};
	box_ptr3->set_material(glossy_ptr3);
	add_object(box_ptr3);
	
	float exp4 = 100.0;
	auto glossy_ptr4 = make_shared<GlossyReflector>();
	glossy_ptr4->set_cd(RGBColor{0, 0.5, 0.25});
	...
	Box* box_ptr4 = new Box{
		{5 * checker_size, 0, -0.5},
		{9 * checker_size, 5 * checker_size, 0.0}};
	...
	plane_ptr1->set_material(make_shared<Matte>(.25, .25, white));
